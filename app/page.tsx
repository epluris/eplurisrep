        ...
        <div className="mb-12 rounded-xl border border-green-800/50 bg-gradient-to-r from-black to-gray-900/50 p-8 glow">
          <div className="max-w-3xl">
            ...
            <p className="mb-6 text-lg text-gray-300 leading-relaxed">
              No more hunting through dozens of websites. <span className="text-green-400 font-semibold">ePluris</span> aggregates, organizes, 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            ...
            <div className="flex gap-6">
              ...
              <a href="/contact" className="text-sm text-green-600 hover:text-green-400">Contact</a>
              <a href="https://github.com" className="text-sm text-green-600 hover:text-green-400">GitHub</a>
            </div>
          </div>
          <div className="mt-8 text-center text-xs text-green-800">
            © 2024 ePluris. An independent public service project.
          </div>
        </div>
      </footer>
    </div>
